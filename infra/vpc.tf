...
# NAT Gateway for private subnets to pull images
...
resource "aws_security_group" "gateway" {
  name_prefix = "${var.project_name}-gw-"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "collector" {
  ...
  tags = { Name = "${var.project_name}-collector-sg" }
}
...
resource "aws_security_group" "clickhouse" {
  ...
  tags = { Name = "${var.project_name}-clickhouse-sg" }
}
